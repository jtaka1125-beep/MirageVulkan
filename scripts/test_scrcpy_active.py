...
# Generate screen activity in background
def touch_loop():
    for i in range(20):
        subprocess.run(["adb", "-s", serial, "shell", "input", "swipe", "360", "800", "360", "200", "100"],
                       capture_output=True)
        time.sleep(0.3)
...
print("Server running, connecting TCP + generating touch input...")
