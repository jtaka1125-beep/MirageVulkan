 ...
 * 
 * Usage:
 *   adb shell am broadcast -a com.mirage.capture.DEBUG_CMD --es cmd tap --ei x 400 --ei y 634
 *   adb shell am broadcast -a com.mirage.capture.DEBUG_CMD --es cmd swipe --ei x1 400 --ei y1 200 --ei x2 400 --ei y2 800 --ei dur 300
 *   adb shell am broadcast -a com.mirage.capture.DEBUG_CMD --es cmd longpress --ei x 400 --ei y 634 --ei dur 1000
 *   adb shell am broadcast -a com.mirage.capture.DEBUG_CMD --es cmd back
 */
class DebugCommandReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        if (intent?.action != "com.mirage.capture.DEBUG_CMD") return
