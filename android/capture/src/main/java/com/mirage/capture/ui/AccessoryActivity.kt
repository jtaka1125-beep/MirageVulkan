...
import com.mirage.capture.access.MirageAccessibilityService
import com.mirage.capture.usb.AccessoryIoService
...
class AccessoryActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val ACTION_USB_PERMISSION = "com.mirage.capture.USB_PERMISSION"
    }
